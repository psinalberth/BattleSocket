...
public class BattleSocket {
    ...
    private void init() throws SocketException, UnknownHostException {
        ...
        server.setReceiveBufferSize(64);
    ...
    public int[] read() {
        ...
        while (true) {
            ...
            try {
                ...
                rs[0] = str.substring(0, 3);
                rs[1] = str.substring(3, 6);
                
                int move[] = new int[2];
                move[0] = Integer.parseInt(rs[0].replaceAll("\\s", ""));
                move[1] = Integer.parseInt(rs[1].replaceAll("\\s", ""));
